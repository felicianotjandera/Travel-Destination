...
$id_testimoni = $_GET["ubahtestimoni"];
$edit = mysqli_query($conn, "SELECT * from testimoni WHERE id_testimoni = '$id_testimoni'");
     ...
     if(isset($_POST['ubah']))
 	 {
		...
		if ($file_size > 2097152) {
			...
			if ($namafoto == "") {
				mysqli_query($conn, "UPDATE testimoni SET id_testimoni = '$id_testimoni', judul_testimoni = '$judul_testimoni', isi_testimoni = '$isi_testimoni', nama_testimoni = '$nama_testimoni', kode_kabupaten = '$kode_kabupaten' WHERE id_testimoni = '$id_testimoni'");
			} else {
				mysqli_query($conn, "UPDATE testimoni SET id_testimoni = '$id_testimoni', judul_testimoni = '$judul_testimoni', isi_testimoni = '$isi_testimoni', nama_testimoni = '$nama_testimoni', kode_kabupaten = '$kode_kabupaten' foto_testimoni = '$namafoto' WHERE id_testimoni = '$id_testimoni'");
			}    
...
<form method="POST" enctype="multipart/form-data">
  <div class="row mb-3 mt-5">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="testimoniID" name="inputID" value="<?php echo $row_edit["id_testimoni"]?>" readonly> 
    </div>
  </div>
  <div class="row mb-3">
    <label for="testimoniJUDUL" class="col-sm-2 col-form-label">Judul Testimoni</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="testimoniJUDUL" name="inputJUDUL" value="<?php echo $row_edit["judul_testimoni"]?>">
    </div>
  </div>
  <div class="row mb-3">
    <label for="testimoniISI" class="col-sm-2 col-form-label">Isi Testimoni</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="testimoniISI" name="inputISI" value="<?php echo $row_edit["isi_testimoni"]?>">
    </div>
  </div>
  <div class="row mb-3">
    <label for="testimoniNAMA" class="col-sm-2 col-form-label">Nama Testimoni</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="testimoniNAMA" name="inputNAMA" value="<?php echo $row_edit["nama_testimoni"]?>">
    </div>
  </div>
