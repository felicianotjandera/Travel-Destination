...
$kode_kecamatan = $_GET["ubahkecamatan"];
$edit = mysqli_query($conn, "SELECT * from kecamatan WHERE kode_kecamatan = '$kode_kecamatan'");
...
if (isset($_POST['ubah'])) {
    ...
    if ($file_size > 2097152) { 
        ...
        if ($namafoto == "") {
            mysqli_query($conn, "UPDATE kecamatan SET nama_kecamatan = '$nama_kecamatan', kode_kabupaten = '$kode_kabupaten' WHERE kode_kecamatan = '$kode_kecamatan'");
        } else {
            mysqli_query($conn, "UPDATE kecamatan SET nama_kecamatan = '$nama_kecamatan', kode_kabupaten = '$kode_kabupaten', foto_kecamatan = '$namafoto' WHERE kode_kecamatan = '$kode_kecamatan'");
        }    
...
<form method="POST" enctype="multipart/form-data">
    <div class="row mb-3 mt-5">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="kodeKec" name="inputKODE" value="<?php echo $row_edit["kode_kecamatan"]?>" readonly> 
        </div>
    </div>
    <div class="row mb-3">
        <label for="namaKec" class="col-sm-2 col-form-label">Nama Kecamatan</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="namaKec" name="inputNAMA" value="<?php echo $row_edit["nama_kecamatan"]?>">
        </div>
    </div>
