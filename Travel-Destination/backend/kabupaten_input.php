...
if (isset($_POST['Simpan'])) {
    ...
    if ($file_size > 2097152) { 
        ...
        mysqli_query($conn, "INSERT INTO kabupaten VALUES ('$kode_kabupaten', '$nama_kabupaten', '$alamat_kabupaten', '$kode_provinsi', '$namafoto')");
...
<form method="POST" enctype="multipart/form-data">
    <div class="row mb-3 mt-5">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="kodeKab" name="inputKODE" placeholder="Kode Kabupaten"> 
        </div>
    </div>
    <div class="row mb-3">
        <label for="namaKab" class="col-sm-2 col-form-label">Nama Kabupaten</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="namaKab" name="inputNAMA" placeholder="Nama Kabupaten">
        </div>
    </div>
    <div class="row mb-3">
        <label for="alamatKab" class="col-sm-2 col-form-label">Alamat Kabupaten</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="alamatKab" name="inputALAMAT" placeholder="Alamat Kabupaten">
        </div>
    </div>
...
<table class="table table-striped table-success table-hover mt-5">
    ...
    <?php while ($row = mysqli_fetch_array($query)) { ?>
        <tr class="danger">
            ...
            <td>
                <a href="kabupaten_edit.php?ubahkabupaten=<?php echo $row["kode_kabupaten"]?>" class="btn btn-success btn-sm" title="EDIT">
